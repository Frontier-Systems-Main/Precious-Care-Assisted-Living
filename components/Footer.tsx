  ...
  return (
    <footer className="border-t border-[#f5b8dd] bg-[#063550] text-white">
      <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-14 lg:px-8">
        <div className="grid gap-8 text-left sm:gap-10 lg:grid-cols-[1.05fr_0.9fr_1fr] lg:gap-12">
          <div>
            ...
            <p className="mt-5 max-w-md text-[0.9rem] leading-7 text-white/72 lg:mt-7 lg:text-[0.94rem]">
        ...
        <div className="mt-10 border-t border-white/12 pt-5 sm:mt-12 sm:pt-6">
          <div className="flex flex-col gap-2 text-left text-[0.82rem] text-white/45 sm:gap-3 sm:text-[0.86rem] md:flex-row md:items-center md:justify-between">
